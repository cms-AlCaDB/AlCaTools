...
process.AlCaRecoTriggerBitsRcdUpdate.alcarecoClone = []
process.AlCaRecoTriggerBitsRcdUpdate.triggerListsAdd = [
        cms.PSet(listName = cms.string('SiPixelCalZeroBias'),
            hltPaths = cms.vstring('NonExistingAlCaReco'))
        ]
'''
process.AlCaRecoTriggerBitsRcdUpdate.alcarecoClone = [
    cms.PSet(oldKey = cms.string('SiStripCalZeroBias'),
             newKey = cms.string('SiPixelCalZeroBias')
             )
    ]
'''
