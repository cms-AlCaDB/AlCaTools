...
# with command line options: step3 --conditions 105X_upgrade2018_realistic_v6 -n 5 --era Run2_2018 -s DIGI:pdigi_valid --datatier GEN-SIM-DIGI-RAW --eventcontent FEVTDEBUGHLT --filein file:output_step2_SIM.root --fileout output_step3_DIGI.root --customise_commands=process.GlobalTag.DumpStat =cms.untracked.bool(True) --outputCommands keep *_simCastorDigis_*_*
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Run2_2018_cff import Run2_2018

process = cms.Process('DIGI',Run2_2018)
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:output_step2_SIM.root'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('output_step3_DIGI.root'),
...
process.FEVTDEBUGHLToutput.outputCommands.append('keep *_simCastorDigis_*_*')
