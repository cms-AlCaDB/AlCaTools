...
### MAIN LOOP ###
    ...
    for element in GTMap_ref:
        ...
        #print RefRecord,RefLabel,RefTag
    ...
    for Rcd in sorted(differentTags):
        ...
        #print Rcd," 1:",differentTags[Rcd][0]," 2:",differentTags[Rcd][1]
        ...
        if(opts.lastIOV):
            ...
            #print Rcd[0],"ref tag size:",len(refTagIOVs)," target tag size:",len(tarTagIOVs)            
            ...
            for refIOV in refTagIOVs:            
                ...
                #print "|",refIOV[2],"|",RefIOVtime,"|",refSnap,(refIOV[2]>RefIOVtime),(refIOV[2]<refSnap), (refIOV[0] < int(opts.testRunNumber)),(refIOV[0]>=sinceRefTagIOV)
            ...
            #print Rcd[0],"ref tag size:",len(refTagIOVs)," target tag size:",len(tarTagIOVs)
            #print Rcd[0],"ref hash:",theRefPayload," target hash:",theTarPayload
