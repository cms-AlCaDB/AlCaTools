...
process.AlCaRecoTriggerBitsRcdRead.rawFileName = 'triggerBits_AlCaRecoHLTpaths8e29_1e31_v7_hlt'
...
process.source = cms.Source("EmptySource",
                            ...
                            firstRun = cms.untracked.uint32(271700)
                            )
...
process.dbInput = cms.ESSource(
    ...
    toGet = cms.VPSet(cms.PSet(
        ...
        tag = cms.string('AlCaRecoHLTpaths8e29_1e31_v7_hlt') # choose tag you want
        )
    )
)
